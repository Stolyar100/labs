import readchar
from Equation4 import LinearEquation, QuadEquation
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        if command == 'e':
            ...
            equation.calculate_root()
            equation.read_roots(equation.a, equation.b)
            ...
            equation.read_roots(equation.a, equation.b, equation.c)
